    ...
    return (
      <KeyboardAwareScrollView contentContainerStyle={styles.MainContainer}>
        <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <Text style={[styles.Label, {fontSize:15,color: "#7A869A", marginTop:20}]}>How much do you want to invest?</Text>

            <Text style={[styles.Label, {fontSize:15,marginTop:10,color: "#7A869A",}]}> Define Your Monthly payment limit to your Account</Text>
